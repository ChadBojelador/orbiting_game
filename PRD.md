...
- WASD/arrows move, mouse aims with pointer lock, Space jumps or swims upward, Shift slides, C crouches, and Control sprints. Mobile provides a movement stick, drag-to-look region, fire, aim, jump/swim, slide, reload, weapon cycling, scoreboard, crouch, and sprint buttons. Island sea water applies buoyancy and drag, suspends sprint/slide boosts, and keeps a player partially submerged; Frostline channels and Original World river ribbons remain shallow wading water; Original World ocean buoyancy uses its original Y=1.5 sea surface.
