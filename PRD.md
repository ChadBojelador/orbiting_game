...
## Playable release
- First-person keyboard/mouse and mobile touch play on Frostline, an original 120 × 120 metre frozen research arena, and Frost Island, a 160 × 160 metre combat archipelago built around the preserved supplied Fort derivative.
- WASD/arrows move, mouse aims with pointer lock, Space jumps or swims upward, Shift slides, C crouches, and Control sprints. Mobile provides a movement stick, drag-to-look region, fire, aim, jump/swim, slide, reload, weapon cycling, scoreboard, crouch, and sprint buttons. Island sea water applies buoyancy and drag, suspends sprint/slide boosts, and keeps a player partially submerged; Frostline channels remain shallow wading water.
