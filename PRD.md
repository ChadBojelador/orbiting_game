...
## Asset policy
Veck.io informs broad arena-FPS qualities. The user authorized reuse of the supplied Island and wooden-house GLBs. Their embedded source/author/license metadata and derivative changes are retained in `assets/asset-provenance.md`; underlying permission documentation remains a release gate because the Island metadata identifies a reupload. The full 136.6 MB source is retained but only the optimized Fort sector ships. Existing project character/music assets serve the lobby. No Veck.io site assets were downloaded.
