...
Implementation adaptation (2026-09-15): the concurrent approved layout expands horizontal dimensions from 80 m to 120 m; vertical scale remains unchanged. The persistent character lobby supersedes the initial arena-preview menu composition. Island - Fort and the supplied wooden house have separate provenance and shared collision documented in MAP_SPEC.md and assets/asset-provenance.md.
