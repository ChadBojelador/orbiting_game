...
- Nine land regions: village, forest, Crystal Valley, Ice Peaks, meadow, beach, and three coastal islands. Retains the village crystal, ancient tree, crystal spire, ice summit, meadow windmill, beach arch, original river network, two waterfalls and four bridges. The village crystal, Crystal Valley spire, and island moonstone are emissive nighttime landmarks and the map's three bounded local light sources.
