export interface FpsSettings { sensitivity:number; fov:number; volume:number; crosshair:string; reducedEffects:boolean; controls:'auto'|'touch'|'mouse' }
export const DEFAULT_SETTINGS:FpsSettings={sensitivity:1,fov:96,volume:0.35,crosshair:'#ffffff',reducedEffects:false,controls:'auto'};
