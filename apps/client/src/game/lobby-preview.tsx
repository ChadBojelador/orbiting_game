...
export function LobbyPreview(){
  ...
  useEffect(()=>{
    ...
    const camera=new PerspectiveCamera(48,1,0.1,180);camera.position.set(54,49,64);camera.lookAt(0,0,0);
    ...
    return ()=>{observer.disconnect();map.destroy();renderer.dispose();};
  },[]);
