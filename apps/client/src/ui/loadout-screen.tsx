...
export function LoadoutScreen({
  ...
  return (
    <section className="loadout" aria-label="Loadout">
      <h3>Loadout</h3>
      ...
      <p>
        {weapon.damage}
        {weapon.pelletsPerShot > 1 ? ` × ${weapon.pelletsPerShot}` : ''} damage ·{' '}
        {weapon.magazineSize} rounds · {weapon.range} m range
      </p>
      <small>2 · Snowmelt pistol &nbsp; 3 · Ice Pick</small>
    </section>
  );
}
