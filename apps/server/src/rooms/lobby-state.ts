...
export const PlayerState = schema(
  {
    ...
    lungeUntil: t.number().default(0),
    lungeReadyAt: t.number().default(0),
    lungeDirectionX: t.float32().default(0),
    lungeDirectionZ: t.float32().default(0),
    isWallRunning: t.boolean().default(false),
  },
  'PlayerState',
);
...
export const LobbyState = schema(
  {
    ...
    gameMode: t.string<GameMode>().default('tdm'),
    mapId: t.string<MapId>().default('frostline'),
    iceScore: t.uint16().default(0),
    waterScore: t.uint16().default(0),
    waterStartedCount: t.uint16().default(0),
    waterUnfrozenCount: t.uint16().default(0),
