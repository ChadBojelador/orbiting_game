...
export const PlayerState = schema(
  {
    ...
    status: t.string<PlayerStatus>().default('alive'),
    protectedUntil: t.number().default(0),
    isSliding: t.boolean().default(false),
    isCrouching: t.boolean().default(false),
    slideUntil: t.number().default(0),
    slideReadyAt: t.number().default(0),
    hp: t.float32().default(GAMEPLAY.maxHp),
    kills: t.uint32().default(0),
    deaths: t.uint32().default(0),
    currentWeaponSlot: t.uint8().default(0),
    primaryWeapon: t.string<WeaponId>().default('assault-rifle'),
    weaponId: t.string<WeaponId>().default('assault-rifle'),
    ammo: t.uint16().default(30),
    reserveAmmo: t.uint16().default(120),
    reloadUntil: t.number().default(0),
    fireReadyAt: t.number().default(0),
    respawnAt: t.number().default(0),
    spawnGeneration: t.uint32().default(0),
    lastKillerId: t.string().default(''),
    lastDeathWeapon: t.string<WeaponId>().default('assault-rifle'),
...
export const LobbyState = schema(
  {
    ...
    gameMode: t.string<GameMode>().default('ffa'),
    mapId: t.string<MapId>().default('frostline'),
    iceScore: t.uint16().default(0),
    waterScore: t.uint16().default(0),
    matchWinner: t.string().default(''),
    resultReason: t.string<MatchResult['reason'] | ''>().default(''),
